...
test_that("Output of site related resources function constructs ‘tibble’ as expected", {
  result <- ReLTER::get_site_related_resources(deimsid = 'https://deims.org/f30007c4-8a6e-4f11-ab87-569db54638fe')
...
test_that("Wrong input (but URL) constructs a tibble with empty data", {
  result <- ReLTER::get_site_related_resources(deimsid = 'https://deims.org/ljhnhbkihubib')
