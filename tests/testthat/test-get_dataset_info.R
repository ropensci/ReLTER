...
test_that("Expect error if internet connection is down", {
  testthat::expect_error(
    httptest::without_internet(
      result <- ReLTER::get_dataset_info(datasetid = "https://deims.org/dataset/38d604ef-decb-4d67-8ac3-cc843d10d3ef")
    ),
    "GET"
  )
})
...
test_that("Wrong input (but URL) constructs a NULL object", {
  result <- ReLTER::get_dataset_info(datasetid = "https://deims.org/dataset/ljhnhbkihubib")
