...
The [`get_site_info`](https://oggioniale.github.io/ReLTER/reference/get_site_info.html) function of {ReLTER} allows to download details about a specific site, through the DEIMS-SDR sites API and the DEIMS ID (<https://deims.org/docs/deimsid.html>).
...
## Get list of parameters, related resources or reserch topics declared to the LTER site:
...
siteResearchTop <- ReLTER::get_site_info(
  deimsid = "https://deims.org/f30007c4-8a6e-4f11-ab87-569db54638fe",
  category = "ResearchTop"
)
# research topics(ies) of site
knitr::kable(
  siteResearchTop$researchTopics[[1]],
  caption = "The list of the funding agency(ies) of site"
)
```
