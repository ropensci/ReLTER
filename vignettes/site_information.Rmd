...
The [`get_site_info`](https://ropensci.github.io/ReLTER/reference/get_site_info.html) function of {ReLTER} allows to download details about a specific site, through the DEIMS-SDR sites API and the DEIMS ID (<https://deims.org/docs/deimsid.html>).
