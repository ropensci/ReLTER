...
Knowing the network elTER id (DEIMS ID of the Network, e.g. LTER-Italy <https://deims.org/network/7fef6b73-e5cb-4cd2-b438-ed32eb1504b3>), the [`get_network_sites`](https://ropensci.github.io/ReLTER/reference/get_network_sites.html) can download general info, such as name, DEIMS.iD and coordinates of the sites belonging to the network selected. A map of the sites can be returned.
...
* Environmental characteristics by [`get_network_envcharacts`](https://ropensci.github.io/ReLTER/reference/get_network_envcharacts.html)
* Parameters by [`get_network_parameters`](https://ropensci.github.io/ReLTER/reference/get_network_parameters.html)
* Related resources  by [`get_network_related_resources`](https://ropensci.github.io/ReLTER/reference/get_network_related_resources.html)
* Research topics by [`get_network_research_topics`](https://ropensci.github.io/ReLTER/reference/get_network_research_topics.html)
...
Starting by the list of the LTER-Italy network's sites ([see first example above](#firstExample)), or by using any DEIMS ID list, through the [`get_site_info`](https://ropensci.github.io/ReLTER/reference/get_site_info.html) function (already described [here](./site_information.html)).
