...
<<<<<<< HEAD
* Environmental characteristics by [`get_network_envcharacts`](https://oggioniale.github.io/ReLTER/reference/get_network_envcharacts.html)
* Parameters by [`get_network_parameters`](https://oggioniale.github.io/ReLTER/reference/get_network_parameters.html)
* Related resources  by [`get_network_related_resources`](https://oggioniale.github.io/ReLTER/reference/get_network_related_resources.html)
* Research topics by [`get_network_research_topics`](https://oggioniale.github.io/ReLTER/reference/get_network_research_topics.html)
=======
...
* Parameters by [`get_network_parameters`](https://docs.ropensci.org/ReLTER/reference/get_network_parameters.html)
...
* Research topics by [`get_network_research_topics`](https://docs.ropensci.org/ReLTER/reference/get_network_research_topics.html)
>>>>>>> dev
...
<<<<<<< HEAD
Starting by the list of the LTER-Italy network's sites ([see first example above](#firstExample)), or by using any DEIMS.iD list, through the [`get_site_info`](https://oggioniale.github.io/ReLTER/reference/get_site_info.html) function (already described [here](./site_information.html)).
=======
