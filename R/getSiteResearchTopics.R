...
#' @export
#' @examples
#' tSiteResearchTopics <- getSiteResearchTopics(deimsid = 'https://deims.org/f30007c4-8a6e-4f11-ab87-569db54638fe')
#' tSiteResearchTopics
#'
...
getSiteResearchTopics <- function(deimsid) {
  ...
  invisible(capture.output(researchTopics <- tibble::as_tibble(ReLTER::do_Q(q, jj))))
