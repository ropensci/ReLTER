#' from eLTER-Plus "Field specification for data reporting"
#' https://doi.org/10.5281/zenodo.6373410
#' and from the new version of eLTER data reporting format proposed here
#' https://docs.google.com/spreadsheets/d/1wTiwb_5uM_XGsrSWUx9h2t4maSSFg7mpggq2nIydWco
#' @noRd
eLTER_data_reporting_format <- list(
  version1.3 = c(
    list(
      DATA = list(
        measurements_coreFields = c(
          "SITE_CODE", "STATION_CODE",
          "ABS_POSITION","VERT_OFFSET",
          ...
          "FLAGSTA", "EVENT_ID", "SAMPLE_ID"
        ),
        mapping_coreFields = c(
          "SITE_CODE", "STATION_CODE",
          "ABS_POSITION","VERT_OFFSET",
          "HORI_OFFSET", #horizontal offset (gbif:coordinateUncertaintyInMeters?)
          "TIME", "VARIABLE",
          "LAYER", # botanic only?
          "TAXA", "VALUE", # TRUE/FALSE for occurence? or 0/1?
          "UNIT",
          "FLAGQUA", # eventually add REFERENCE file describing meaning for different sources
          "EVENT_ID", "SAMPLE_ID"
        ),
        extendedFields = c(
          "ORG_NAME", "SUBPROG", "MEDIUM",
          "LISTMED", "MAX_LEVEL", "MIN_LEVEL",
          "SIZE", "YEAR", "MONTH",
          "DAY", "HOUR", "MINUTE",
          "SECOND", "SPOOL", "TPOOL",
          "TLEVEL", "LISTTAXA", "LISTSUB", "FLAGSTA"
        )
      ),
      REFERENCE = c(
        "FIELD_NAME", "CODE", "NAME",
        "DEFINITON", "LIST_CODE", "CODE_URL"
      ),
      METHOD = c(
        "VARIABLE", "METH_DESCR", "UNIT",
        "SAMPLING_DESIGN", "FIELD_METHOD",
        "LAB_METHOD", "AGG_METHOD"
      ),
      STATION = c(
        "SITE_CODE", "STATION_CODE","STYPE",
        "LAT", "LON", "ALTITUDE",
        "PLOTSIZE","COMMENT", "GEOSPAT_FEATURE",
        "SNAME", "westBoundingCoordinate",
        "eastBoundingCoordinate", "northBoundingCoordinate",
        "southBoundingCoordinate", "altitudeMin", "altitudeMax",
        "Country", "OperationPeriodSince", "plotDimension",
        "numberOfSampleUnit", "InstHeight", "Local_Habitat_Type",
        "EUNIS_Habitat_Type", "Potential_natural_vegetation"
      ),
      EVENT = list(
        coreFields = c(
          "SITE_CODE", "STATION_CODE", "EVENT_ID",
          "TIME_FROM", "TIME_TO", "METH_DESCR",
          "EVENT_EFFORT", "UNIT", "PHYS_SAMPLE", "NOTES"
        ),
        extendedFields = c(
          "PARENT_EVENT_ID", "SAMP_EFFORT",
          "HABITAT_TYPE", "SOIL_TYPE"
        )
      ),
      SAMPLE = c(
        "SITE_CODE", "STATION_CODE", "EVENT_ID",
        "SAMPLE_ID", "MEDIUM", "TIME_FROM",
        "TIME_TO", "METH_DESCR", "SAMP_SIZE",
        "UNIT", "NOTES"
      )
    )
  ),
