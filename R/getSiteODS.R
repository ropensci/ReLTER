#' @title eLTER getSiteODS function
#'
#' @description This function acquires various raster layers from
#' ODS Europe:  https://maps.opendatascience.eu/
#' and crops to an eLTER site boundary, which is obtained from the DEIMS-SDR sites API.
#'
...
#' Natura2000: Protected areas rasterized from NATURA 2000 (A, B and C site categories)
#'    and OSM (IUCN Ia, IUCN Ib, IUCN 2, IUCN 3, IUCN 4, IUCN 5, IUCN 6 and others categories),
#'    first to 10m spatial resolution and after downsampled to 30m by spatial average.
...
#' siteLandcover <- getSiteODS(
#'                          deimsid = "https://deims.org/17210eba-d832-4759-89fa-9ff127cbdf6e",
#'                          dataset = "landcover"
#'                          )
#' NDVI for Eisenwurzen
#' siteNDVI <- getSiteODS(deimsid = "https://deims.org/d0a8da18-0881-4ebe-bccf-bc4cb4e25701",
#'                          dataset = "ndvi_summer"
#'                          )
#'

### function getSiteODS
getSiteODS <- function(deimsid, dataset = "landcover") {
  ...
  landcover <- "lcv/lcv_landcover.hcl_lucas.corine.rf_p_30m_0..0cm_2019_eumap_epsg3035_v0.1.tif"
  clc2018 <- "lcv/lcv_landcover.clc_corine_c_100m_0..0cm_2018_eumap_epsg3035_v2020.tif"
  osm_buildings <- "lcv/lcv_building_copernicus.osm_p_30m_0..0cm_2018..2021_eumap_epsg3035_v0.1.tif"
  natura2000 <- "adm/adm_protected.area_natura2000.osm_p_30m_0..0cm_2019..2021_eumap_epsg3035_v0.1.tif"
  ndvi_spring <- "lcv/lcv_ndvi_landsat.glad.ard_p50_30m_0..0cm_201903_eumap_epsg3035_v1.0.tif"
  ndvi_summer <- "lcv/lcv_ndvi_landsat.glad.ard_p50_30m_0..0cm_201906_eumap_epsg3035_v1.0.tif"
  ndvi_autumn <- "lcv/lcv_ndvi_landsat.glad.ard_p50_30m_0..0cm_201909_eumap_epsg3035_v1.0.tif"
