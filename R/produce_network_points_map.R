...
#' country. If the network contains extraterritorial sites, a map of these can
#' be generated by specifying the network’s DEIMS-ID and providing, in the
#' country parameter, the country in which the extraterritorial sites are
#' located.
